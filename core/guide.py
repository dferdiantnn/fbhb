...
def show_user_guide():
    ...
    while True:
        ...
        if p == "1":
            ...
            print(Fore.GREEN + "\n   1. Direct Mode (Bawaan & Paling Mudah):")
            print(Fore.WHITE + "      Memakai internet normal laptop kamu. Cepat, praktis, tanpa ribet setting.")
            print(Fore.CYAN + "\n   💡 TRIK RAHASIA GANTI IP GRATIS (TRIK MODE PESAWAT):")
            print(Fore.WHITE + "      • Sambungkan laptop kamu ke Hotspot / Tethering dari HP.")
            print(Fore.WHITE + "      • Kalau mau ganti IP baru: Aktifkan Mode Pesawat di HP selama 5 detik,")
            print(Fore.WHITE + "        lalu matikan lagi. Provider seluler akan langsung memberikan")
            print(Fore.WHITE + "        IP Publik Indonesia yang 100% baru, segar, dan alami!")
            print(Fore.YELLOW + "\n   2. Proxy Mode (Khusus Jika Punya Proxy Sendiri):")
            print(Fore.WHITE + "      Jika kamu/outlet kamu memiliki langganan Proxy SOCKS5/HTTP pribadi,")
            print(Fore.WHITE + "      kamu bisa langsung memasukkan alamat proxynya di submenu ini.")
            print(Fore.CYAN + "\n   Di menu ini Kakak juga bisa cek alamat IP publik laptop secara langsung!")
            input(Fore.YELLOW + "\n   [Tekan Enter untuk kembali...]" + Fore.RESET)
